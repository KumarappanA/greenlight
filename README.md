...
1. Read `brief.md` first — particularly the three-lane model and the
   "false green" part of the risks section, since everything else depends
   on that holding up.
2. Open `prototype/index.html` and click through the review queue. Look at
